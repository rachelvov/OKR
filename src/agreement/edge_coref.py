...
def compute_edge_coref_agreement(graph1, graph2):
    """
    Receives two annotated graphs and computes the agreement on the entity coreference:
    ...
    # each measure
    muc1, bcubed1, ceaf1 = muc(graph1_edge_mentions, graph2_edge_mentions), \
                           bcubed(graph1_edge_mentions, graph2_edge_mentions), \
                           ceaf(graph1_edge_mentions, graph2_edge_mentions)
    mela1 = np.mean([muc1, bcubed1, ceaf1])

    muc2, bcubed2, ceaf2 = muc(graph2_edge_mentions, graph1_edge_mentions), \
                           bcubed(graph2_edge_mentions, graph1_edge_mentions), \
                           ceaf(graph2_edge_mentions, graph1_edge_mentions)
